...
<Project Type="Project" LVVersion="16008000">
	...
	<Property Name="varPersistentID:{102B4755-CC25-4111-B90C-A544A626D280}" Type="Ref">/NI-myRIO-C2-421-04/Untitled Library 4.lvlib/A_DIO8 (Pin 27)</Property>
	<Property Name="varPersistentID:{179CC8BA-B915-4143-BC68-32AC47D2A5A7}" Type="Ref">/NI-myRIO-C2-421-04/Untitled Library 13.lvlib/data (B_DIO0 (Pin 11))</Property>
	<Property Name="varPersistentID:{1A702505-2881-4A02-8B6B-142507013980}" Type="Ref">/NI-myRIO-C2-421-04/Untitled Library 5.lvlib/A_DIO7 (Pin 25)</Property>
	<Property Name="varPersistentID:{1C59E4AA-73C0-49C8-BDD1-2A85D3F70DC5}" Type="Ref">/NI-myRIO-C2-421-04/Untitled Library 11.lvlib/A_DIO1 (Pin 13)</Property>
	<Property Name="varPersistentID:{25E6FF61-CA79-46A8-B682-E956FE0132A7}" Type="Ref">/NI-myRIO-C2-421-04/Untitled Library 8.lvlib/A_DIO4 (Pin 19)</Property>
	<Property Name="varPersistentID:{268A70A6-7593-4866-82A6-04B2F080B515}" Type="Ref">/NI-myRIO-C2-421-04/Untitled Library 14.lvlib/latch (B_DIO2 (Pin 15))</Property>
	<Property Name="varPersistentID:{68E14B24-1434-4E70-94F6-EAE8F19EB2A7}" Type="Ref">/NI-myRIO-C2-421-04/Untitled Library 3.lvlib/A_DIO9 (Pin 29)</Property>
	<Property Name="varPersistentID:{72277156-3B46-4513-9C9B-F1E40860A43E}" Type="Ref">/NI-myRIO-C2-421-04/Untitled Library 12.lvlib/A_DIO0 (Pin 11)</Property>
	<Property Name="varPersistentID:{7C1DF05F-0BBE-41DC-A54D-0C8A0F11FBD4}" Type="Ref">/NI-myRIO-C2-421-04/Untitled Library 7.lvlib/A_DIO5 (Pin 21)</Property>
	<Property Name="varPersistentID:{8B4AB910-F277-4010-822B-62E1C5AC9EF0}" Type="Ref">/NI-myRIO-C2-421-04/Untitled Library 6.lvlib/A_DIO6 (Pin 23)</Property>
	<Property Name="varPersistentID:{B77B7F0C-6CA9-4CAA-B0EE-03237BB9A604}" Type="Ref">/NI-myRIO-C2-421-04/Untitled Library 10.lvlib/A_DIO2 (Pin 15)</Property>
	<Property Name="varPersistentID:{D8A1D2D1-5841-4947-8535-C66489E0D43C}" Type="Ref">/NI-myRIO-C2-421-04/Untitled Library 2.lvlib/A_DIO10 (Pin 31)</Property>
	<Property Name="varPersistentID:{E728784B-64F7-4A33-9023-65F944E0683E}" Type="Ref">/NI-myRIO-C2-421-04/Untitled Library 15.lvlib/clk (B_DIO1 (Pin 13))</Property>
	<Property Name="varPersistentID:{E7D1D11B-11B6-4DFB-8496-6CA51711D505}" Type="Ref">/NI-myRIO-C2-421-04/Untitled Library 9.lvlib/A_DIO3 (Pin 17)</Property>
	<Property Name="varPersistentID:{E984AA21-3E10-440C-9C3A-707A59E3B4A5}" Type="Ref">/NI-myRIO-C2-421-04/Untitled Library 1.lvlib/A_DIO11 (Pin 18)</Property>
	...
	<Item Name="NI-myRIO-C2-421-04" Type="RT myRIO">
		<Property Name="alias.name" Type="Str">NI-myRIO-C2-421-04</Property>
...
AddOutputFilter chunkFilter
		...
		<Item Name="Untitled Library 13.lvlib" Type="Library" URL="../Untitled Library 13.lvlib"/>
		<Item Name="Untitled Library 14.lvlib" Type="Library" URL="../Untitled Library 14.lvlib"/>
		<Item Name="Untitled Library 15.lvlib" Type="Library" URL="../Untitled Library 15.lvlib"/>
		<Item Name="Dependencies" Type="Dependencies">
